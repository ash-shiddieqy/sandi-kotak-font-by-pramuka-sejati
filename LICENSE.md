...
- Keperluan **pendidikan**, seperti bahan ajar, tugas sekolah, latihan sandi, atau kegiatan belajar  
- Proyek **non-komersial** lainnya yang tidak bertujuan mencari keuntungan finansial

### ⚠️ Dilarang tanpa izin tertulis:
- Menggunakan font ini untuk **tujuan komersial**, termasuk namun tidak terbatas pada:
  - Produk berbayar (merchandise, logo bisnis, aplikasi, iklan, dll)
  - Distribusi ulang berbayar dalam bentuk apa pun
- Mengubah dan mendistribusikan ulang font ini seolah karya sendiri
...
- **Educational use** (teaching materials, school projects, code and cipher practice, etc.)  
- Other **non-commercial** purposes

### ⚠️ You are not allowed, without written permission, to:
- Use these fonts for **commercial purposes**, including but not limited to:
  - Paid products (merchandise, business logos, applications, advertisements, etc.)
  - Redistribution for profit in any form
- Modify or redistribute these fonts as your own work
